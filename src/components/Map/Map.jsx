...
// Modern green pin as SVG base64 for project markers
const greenIcon = new L.Icon({
  iconUrl:
    "data:image/svg+xml;base64,",
  iconSize: [32, 32],
  iconAnchor: [16, 32],
  popupAnchor: [0, -32],
});
...
export default function MapSection({ onShowMapFeatures = () => {} }) {
    ...
    return (
      <section className="py-20 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-semibold text-white">Our Global Impact</h2>
          <p className="text-zinc-400 mt-2">Loading map...</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section id="global-impact" className="h-100 py-20 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-70 bg-emerald-500/5 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-70 bg-cyan-500/5 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16 gap-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-2">
            ...
            <span className="text-emerald-400 text-sm font-medium">Global Projects</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl font-bold text-white relative">
            Our <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Global Impact</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <button
              ...
              className="group inline-flex items-center gap-3 px-6 py-3 rounded-xl font-semibold shadow-lg transform transition-all duration-300 bg-gradient-to-r from-emerald-500 to-cyan-500 text-black hover:shadow-2xl hover:gap-4"
            >
              <BarChart3 size={20} />
            ...
            <button 
              ...
              className="group inline-flex items-center gap-3 px-6 py-3 rounded-xl font-semibold shadow-lg transform transition-all duration-300 bg-gray-800 border border-gray-700 text-white hover:bg-gray-750"
            >
              <Filter size={20} />
        ...
        {/* Filters Panel */}
        {showFilters && (
          <div className="bg-gray-800/50 backdrop-blur-md border border-emerald-500/20 rounded-2xl p-6 mb-8 animate-fadeIn">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-white mb-3">Project Type</h3>
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-white mb-3">Search Projects</h3>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-700">
              ...
              <button 
                onClick={exportData}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors"
              >
                <Download size={16} />
                Export Data
              </button>
        ...
        {/* map */}
        <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-emerald-500/10 mb-16">
          <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/5 to-transparent pointer-events-none z-10"></div>
          <MapContainer
            center={[15, 78]}
            zoom={5}
            scrollWheelZoom={true}
            ref={mapRef}
            className="w-full h-96 md:h-[500px] bg-zinc-900"
          >
            ...
            {filteredProjects.map((p) => (
              <Marker
                ...
                icon={p.id <= 9 ? greenIcon : defaultIcon}
                eventHandlers={{
              ...
              >
                <Popup>
                  <div className="w-72 bg-gray-900 border border-emerald-500/20 rounded-xl p-4">
                    <span className={`inline-block px-3 py-1 text-xs rounded-full border ${typeBadgeColor(p.type)} font-medium`}>
                      {p.type.toUpperCase()}
                    </span>
                    <h4 className="text-emerald-400 mt-3 font-bold text-lg">{p.name}</h4>
                    ...
                    <div className="flex items-center gap-2 text-zinc-400 text-sm mt-1">
                      ...
                      <span><strong className="text-white">Impact:</strong> {p.impact}</span>
                    </div>
                    <p className="text-zinc-400 text-sm mt-3">{p.description}</p>
                    <button className="w-full mt-4 px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-emerald-600 font-semibold text-white hover:shadow-lg transition-shadow">
        ...
        <div ref={statsRef} className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-emerald-500/10 rounded-2xl p-6 text-center backdrop-blur-sm transition-all duration-500 hover:border-emerald-500/30">
            <div className="text-5xl font-black text-emerald-400 mb-2">{projects.length}</div>
            <div className="text-zinc-400 text-lg">Active Projects</div>
          </div>

          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-emerald-500/10 rounded-2xl p-6 text-center backdrop-blur-sm transition-all duration-500 hover:border-emerald-500/30">
            <div className="text-5xl font-black text-emerald-400 mb-2">7</div>
            <div className="text-zinc-400 text-lg">Projects in South India</div>
          </div>

          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-emerald-500/10 rounded-2xl p-6 text-center backdrop-blur-sm transition-all duration-500 hover:border-emerald-500/30">
            <div className="text-5xl font-black text-emerald-400 mb-2">18,500+</div>
            <div className="text-zinc-400 text-lg">Tons CO₂ Reduced Yearly</div>
          </div>
        </div>
      </div>
      ...
      <style>{`
        /* Leaflet popup overrides to match dark UI */
        .leaflet-popup-content-wrapper {
          background: transparent !important;
          color: #e6fef0 !important;
