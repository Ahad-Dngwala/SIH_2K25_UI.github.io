...
const MarketplacePage = () => {
  ...
  const getCategoryColor = (category) => {
    const colors = {
      ...
      'Seagrass': 'bg-purple-100 text-purple-800',
      'Coral': 'bg-orange-100 text-orange-800',
      'Salt Marsh': 'bg-yellow-100 text-yellow-800',
  ...
  const getVerificationColor = (verification) => {
    const colors = {
      'VCS Verified': 'bg-blue-100 text-blue-800',
      'Gold Standard': 'bg-yellow-100 text-yellow-800',
      'MRV Certified': 'bg-green-100 text-green-800',
      'Plan Vivo': 'bg-purple-100 text-purple-800',
      'VCS Certified': 'bg-blue-100 text-blue-800'
    };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 relative overflow-hidden">
      ...
      <div className="bg-white shadow-sm border-b border-slate-200">
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Cenlon Credits</h1>
              <p className="text-slate-600 mt-1">Buy and trade verified carbon credits from ocean restoration projects</p>
            </div>
      ...
      <div className="container mx-auto px-6 py-6">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 mb-8">
          <h2 className="text-2xl font-bold text-slate-800 mb-6">Buy Verified Blue Carbon Credits</h2>
          <p className="text-slate-600 mb-6">Purchase high-quality, verified blue carbon credits from ocean conservation projects. Every credit directly supports marine ecosystem restoration and climate action.</p>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">${statsData.avgPrice}</div>
              <div className="text-sm text-slate-600">Avg. Price</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-slate-800">{statsData.available.toLocaleString()}</div>
              <div className="text-sm text-slate-600">Available</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-slate-800">{statsData.tonsCO2.toLocaleString()}</div>
              <div className="text-sm text-slate-600">Tons CO₂e</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-slate-800">{statsData.projects}</div>
      ...
      <div className="container mx-auto px-6 pb-8">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 mb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <select
              ...
              className="px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent"
            >
          ...
          {/* Price Range Filter */}
          <div className="mt-4">
            <label className="block text-sm font-medium text-slate-700 mb-2">Price Range: ₹{priceRange[0]} - ₹{priceRange[1]}</label>
            <div className="flex items-center gap-4">
              <input
                type="range"
                min="0"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-medium text-blue-800">VCS Verified</span>
            </div>
            <h3 className="text-lg font-bold text-slate-800 mb-2">Mangrove Restoration Credits</h3>
            <p className="text-sm text-slate-600 mb-4">Sundarbans Conservation Initiative</p>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-slate-400" />
                <span className="text-sm text-slate-600">West Bengal, India</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4 text-green-500" />
                <span className="text-sm text-slate-600">Green Delta Foundation</span>
              </div>
              <div className="flex items-center gap-2">
                <Calendar className="w-4 h-4 text-slate-400" />
                <span className="text-sm text-slate-600">Vintage 2024</span>
              </div>
              <div className="flex items-center gap-2">
                <Leaf className="w-4 h-4 text-green-500" />
                <span className="text-sm text-slate-600">1 ton CO₂e per credit</span>
              </div>
            </div>
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="text-sm text-slate-600">Available: 2,500</div>
            </div>
            <button 
              onClick={() => handleAddToCart(carbonCredits[0])}
              className="mt-4 w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25 hover:scale-105"
            >
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-medium text-yellow-800">Gold Standard</span>
            </div>
            <h3 className="text-lg font-bold text-slate-800 mb-2">Seagrass Meadow Credits</h3>
            <p className="text-sm text-slate-600 mb-4">Lakshadweep Marine Conservation</p>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-slate-400" />
                <span className="text-sm text-slate-600">Lakshadweep, India</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4 text-green-500" />
                <span className="text-sm text-slate-600">Ocean Conservation India</span>
              </div>
              <div className="flex items-center gap-2">
                <Calendar className="w-4 h-4 text-slate-400" />
                <span className="text-sm text-slate-600">Vintage 2024</span>
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="text-sm text-slate-600">Available: 1,800</div>
            </div>
            <button 
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-medium text-green-800">Plan Vivo</span>
            </div>
            <h3 className="text-lg font-bold text-slate-800 mb-2">Coral Reef Restoration Credits</h3>
            <p className="text-sm text-slate-600 mb-4">Andaman Coral Recovery Program</p>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-green-500" />
                <span className="text-sm text-slate-600">Andaman & Nicobar Islands</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4 text-green-500" />
                <span className="text-sm text-slate-600">Marine Life Conservancy</span>
              </div>
              <div className="flex items-center gap-2">
                <Calendar className="w-4 h-4 text-slate-400" />
                <span className="text-sm text-slate-600">Vintage 2024</span>
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="text-sm text-slate-600">Available: 900</div>
            </div>
            <button 
        ...
        {/* Volume Sections */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-slate-800 mb-6">Volume 1</h2>
          <div className={`grid gap-6 ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>
            {sortedCredits.filter(credit => credit.volume === 'volume1').map((credit, index) => (
              <div
                key={credit.id}
                className="group relative bg-white rounded-2xl overflow-hidden border border-slate-200 hover:border-green-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25 shadow-sm"
              >
                <div className="relative">
                  {/* Credit Image */}
                  <div className="relative h-48 overflow-hidden">
                    ...
                    >
                      <Heart className={`w-4 h-4 ${wishlist.includes(credit.id) ? 'text-red-500 fill-current' : 'text-slate-600'}`} />
                    </button>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm font-semibold">{credit.rating}</span>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-sm font-semibold text-slate-800">{credit.availableCredits.toLocaleString()}</span>
                      </div>
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 bg-slate-100 text-slate-700 rounded-xl font-medium transition-all duration-300 hover:bg-slate-200 hover:scale-105"
                      >
                      ...
                      <button 
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25 hover:scale-105"
                      >
                        <ShoppingCart className="w-4 h-4" />
                        Add to Cart
                      </button>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-slate-800 mb-6">Volume 2</h2>
          <div className={`grid gap-6 ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>
        ...
        <div className="text-center mt-12">
          <button className="inline-flex items-center gap-2 px-8 py-4 bg-white border border-slate-200 text-slate-700 rounded-full font-semibold transition-all duration-300 hover:bg-slate-50 hover:border-green-400 hover:text-green-600 hover:scale-105">
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-start justify-between mb-6">
                <h2 className="text-3xl font-bold text-slate-800">{selectedCredit.title}</h2>
                <button 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-slate-600">{selectedCredit.description}</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-semibold text-slate-800 mb-2">Impact</h3>
                      <p className="text-slate-600">{selectedCredit.impact}</p>
                    </div>

                    <div>
                      <h3 className="text-lg font-semibold text-slate-800 mb-2">Co-benefits</h3>
                ...
                <div className="space-y-6">
                  <div className="bg-slate-50 rounded-xl p-6">
                    <h3 className="text-lg font-semibold text-slate-800 mb-4">Credit Details</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-slate-600">Price:</span>
                        <span className="font-semibold text-green-600">${selectedCredit.price} per credit</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-600">Available:</span>
                        <span className="font-semibold">{selectedCredit.availableCredits.toLocaleString()} credits</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-600">Vintage:</span>
                        <span className="font-semibold">{selectedCredit.vintage}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-600">Expiry:</span>
                        <span className="font-semibold">{selectedCredit.expiryDate}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-600">Methodology:</span>
                        <span className="font-semibold text-sm">{selectedCredit.methodology}</span>
                      </div>
                    </div>
                  </div>

                  <div className="bg-green-50 rounded-xl p-6">
                    <h3 className="text-lg font-semibold text-slate-800 mb-4">Purchase Options</h3>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-slate-600">Bulk Discount:</span>
                        <span className="font-semibold text-green-600">5% off 100+ credits</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <button 
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-4 bg-slate-100 text-slate-700 rounded-xl font-semibold transition-all duration-300 hover:bg-slate-200 hover:scale-105"
                    >
                    ...
                    <button 
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25 hover:scale-105"
                    >
                      <span>Buy Now</span>
                      <ArrowRight className="w-5 h-5" />
                    </button>
